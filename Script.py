...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>🥱 My Name : {}
👮‍♀ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/MB_Owner'>Rᴏʏ</a>
📚 Lɪʙʀᴀʀʏ: <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ</a>
🖥 Lᴀɴɢᴜᴀɢᴇ:  <a href='https://www.python.org/download/releases/3.0/'>Pʏᴛʜᴏɴ 3</a>
🎪 DᴀᴛᴀBᴀsᴇ: <a href='https://www.mongodb.com/'>MᴏɴɢᴏDB</a></b>"""

    SOURCE_TXT = """<b>ɴᴏᴛᴇ:
- ᴛʜɪs ʙᴏᴛ ᴀɴ ᴘʀɪᴠᴀᴛᴇ sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ

ᴅᴍ ꜰᴏʀ ᴘᴀɪᴅ ʀᴇᴘᴏ ᴇᴅɪᴛs​: @af_x_su</b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/af_x_su)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
